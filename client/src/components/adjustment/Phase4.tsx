...
const Phase4: React.FC = () => {
  ...
  >
    <h2 className="font-bold text-3xl mb-6 text-center text-[#050505]">
        Phase 4: Stepping Into Adjustment
      </h2>
      <p className="text-lg leading-relaxed">
        Stepping into adjustment signifies the initial phase of embracing change and preparing to adapt to new situations, environments, or demands. 

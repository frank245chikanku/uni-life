...
const Phase4: React.FC = () => {
  return (
    ...
    >
      <h2 className="font-bold text-3xl mb-6 text-center">Phase 4: Cultivate Resilience</h2>
      <p className="text-lg leading-relaxed">
        Resilience means being able to cope with tough events. When something bad happens, you still feel anger, grief, and pain, but you're able to keep going, both physically and psychologically. 

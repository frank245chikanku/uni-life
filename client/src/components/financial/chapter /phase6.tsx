  ...
  return (
    ...
    >
      ...
      <p className="text-lg leading-relaxed mb-6">
        Accountability ensures that you remain disciplined and responsible in your actions, particularly when it comes to managing your finances and achieving your goals. For students, this means taking ownership of your financial decisions, whether that involves tracking your expenses, saving for the future, or adhering to a budget.
      </p>
      <p className="text-lg leading-relaxed mb-6">

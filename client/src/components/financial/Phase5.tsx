...
const Phase5: React.FC = () => {
  return (
    ...
    >
      <h2 className="font-bold text-3xl mb-6 text-center">Phase 5: Diversifying Income Streams</h2>
      <p className="text-lg leading-relaxed mb-4">
        When you diversify income streams, it is like planting seeds in your financial garden, each growing at different rates and requiring different amounts of attention, but collectively contributing to a robust and flourishing economic ecosystem.
      </p>
      <p className="text-lg leading-relaxed mb-4">

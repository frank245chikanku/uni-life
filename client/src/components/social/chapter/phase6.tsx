...
const Phase6: React.FC = () => {
  return (
    ...
    >
      <h1 className="font-bold text-3xl mb-6 text-center">Finding Meaning in Service</h1>
      <p className="text-lg leading-relaxed">
        “Only a life lived for others is a life worthwhile.” These words show how serving others can give our lives purpose and joy. 

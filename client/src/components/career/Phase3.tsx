...
const Phase3: React.FC = () => {
  return (
    ...
    >
      <h2 className="font-bold text-3xl mb-6 text-center">Phase 3: Define Your Values</h2>
      <p className="text-lg leading-relaxed">
        Values are the deepest desires of your heart—they provide a scaffolding for how you want to interact with others, yourself, and the world in general.
      ...
      <p className="text-lg leading-relaxed mt-4">
        ...
        <strong> “What valued direction do I want to move in?” </strong>
        and <strong> “Which values would help me head there?”</strong>
      </p>
    </div>
  );
};

...
const Phase2: React.FC = () => {
  ...
  >
    <h2 className="font-bold text-3xl mb-6 text-center text-[#050505]">
      ...
      <ul className="list-disc pl-8 mt-4 text-lg leading-relaxed">
        <li>To persevere, entrepreneurs position actions as continuation of the past, extend timelines and complexify temporal ordering.</li>
        <li>To pivot, they reposition actions on a revised timeline by reinterpreting the past to align with a new projected future.</li>
      </ul>
      <p className="text-lg leading-relaxed mt-4">

  ...
  return (
    ...
    >
      <h2 className="font-bold text-3xl mb-6 text-center text-[#050505]">
        Phase 2: Implementing Best Practices
      </h2>
      ...
      <p className="text-lg leading-relaxed mb-4">
        ...
        students need to master in order to successfully construct an academic text.
      </p>

      <p className="text-lg leading-relaxed mb-4">
        Strategies to redress this could include face-to-face and online workshops. Registration in these could be tied to
        ...
        when staff need them. Presenting information in an appealing way is strategic. At Swinburne University,
        workshops to explain the university’s approach to dealing with plagiarism were knowingly titled “Quick Fix” workshops.
      </p>
